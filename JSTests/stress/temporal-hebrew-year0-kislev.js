...
if (false) {
    ...
    // Ordinal-month and monthCode input must agree on whether y0 Kislev day 30 exists.
    {
        ...
        shouldBe(viaOrdinal.day, viaMonthCode.day, "y0 ordinal month=3 day=30 must agree with monthCode M03 day=30 (currently constrains to 29)");
        ...
        shouldBe(threw, false, "y0 ordinal month=3 day=30 overflow:reject must not throw (currently throws)");
    }
