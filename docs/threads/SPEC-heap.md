...
- **I12**: root set ⊇ stack ∪ registers of every I4(b)-registered thread (suspend-and-copy, §10.6) ∪ `CLoopStack` if `!ENABLE(JIT)` (`Heap.cpp:910`) ∪ each client's `m_currentBlock` cells.
